...
#region Utility methods
        ...
        {
            BillingPayment payment = new BillingPayment(nativeBillingTransaction.GetProductIdentifier(), nativeBillingTransaction.GetQuantity(), nativeBillingTransaction.GetUserTag());
            return payment;
        }
