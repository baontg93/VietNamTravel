...
{
    public static CoroutineAction Coroutine(IEnumerator ie, Action onComplete)
    {
        return new CoroutineAction(Instance, Instance.StartCoroutine(DoCoroutine(ie, onComplete)), onComplete);
    }
